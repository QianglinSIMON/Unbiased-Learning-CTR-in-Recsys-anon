...
def Grid_serch_alpha_CV(alpha_values, batch_size_training, df_unbiased, df_biased,
    ...
    for alpha in alpha_values:
        ...
        for fold, (train_idx, val_idx) in enumerate(kf.split(df_unbiased, df_unbiased["is_click"])):
            ...
            batch_size_train = batch_size_surrogate =batch_size_training
