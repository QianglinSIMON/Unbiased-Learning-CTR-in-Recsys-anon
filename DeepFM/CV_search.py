...
tuning_percentage = 0.35  #0.05,0.1,0.15,0.2,0.25 
...
best_alpha=0.6 #(1,0.8,0.8,0.8,0.6)
...
# mlx worker launch -- python3 CV_search.py


##--batch_size=1024--
## 5% Best alpha: 1 with mean validation AUC: 0.6739662250759295
## 10% Best alpha: 0.8 with mean validation AUC: 0.6831024092006031
## 15% Best alpha: 0.8 with mean validation AUC: 0.6931397032015987
## 20% Best alpha: 0.8 with mean validation AUC: 0.7007832446990072
## 25% Best alpha: 0.6 with mean validation AUC: 0.7044945893308382
## 30% Best alpha: 0.6 with mean validation AUC: 0.7095514828916704
## 35% Best alpha: 0.6 with mean validation AUC: 0.7156674751916529
## 40% Best alpha: 0.6 with mean validation AUC: 0.7183418870926167
