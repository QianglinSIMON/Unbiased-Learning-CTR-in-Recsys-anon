...
early_stopping = EarlyStopping(patience=patience, min_delta=0.001,
                               save_path="Loss_DC_NonPessi_model_pure_{}_percent.pth".format(
...
# 将最佳权重矩阵保存到文件
np.savetxt("DF_best_Nonpessi_pure_{}_percent_alpha_matrix.txt".format(int(100 * tuning_percentage)),
           best_alpha_matrix,
           delimiter=",")

metrics_df.to_csv('metrics_trained_LOSS_DC_Nonpessi_pure_{}_percent.csv'.format(int(100 * tuning_percentage)),
...
# mlx worker launch -- python3 Loss_DC_Nonpessi_pure.py 
