...
# best_alpha, best_val_auc = Grid_serch_alpha_CV(alpha_values=alpha_values, tuning_batch_size=tuning_batch_size, df_unbiased=df_tuning, 
#                                                df_biased=df_biased,
...
#                         l2_reg_agg=l2_reg_agg,seed=seed,
#                         lr=lr, wd=wd, epochs=epochs, patience=patience, device=device)



best_alpha=0.6 #(0.8,0.8,0.8,0.8,0.6)
...
# 5% Best alpha: 0.8 with mean validation AUC: 0.6948602806465729
# 10% Best alpha: 0.8 with mean validation AUC: 0.7054882865218047
# 15% Best alpha: 0.8 with mean validation AUC: 0.7146254575228825
# 20% Best alpha: 0.8 with mean validation AUC: 0.719888210055907
# 25% Best alpha: 0.6 with mean validation AUC: 0.7201048495380672
