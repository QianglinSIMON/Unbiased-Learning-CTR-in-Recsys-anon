...
# 根据目标批次数计算批次大小
batch_size_train=batch_size_surrogate_train =tuning_batch_size 
...
metrics_df.to_csv('metrics_scaling_law_tuning_Pretrained_{}_percent.csv'.format(int(100*tuning_percentage)), index=False) #依赖于微调数据比例
...
# 5% Best alpha: 0.8 with mean validation AUC: 0.6951335918359964
# 10% Best alpha: 0.8 with mean validation AUC: 0.7005301655782482
# 15% Best alpha: 0.8 with mean validation AUC: 0.7056135326755634
# 20% Best alpha: 0.8 with mean validation AUC: 0.7109087790913584
# 25% Best alpha: 0.6 with mean validation AUC: 0.7133184950506507